...
import { cleanUpIntegrationTests, initializeIntegrationTests } from './utils.test';

/**
 * Run extension integration tests with Mocha. All tests must be under 'test/integration/' folder.
 */
export async function run(): Promise<void> {
    ...
    const testsRoot: string = path.join(__dirname, '..', 'integration');
    ...
    }).finally(() => cleanUpIntegrationTests());
}
