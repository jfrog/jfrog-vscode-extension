...
import { TreeDataHolder } from './treeDataHolder';
...
export class IssuesDataProvider extends IssueNode implements vscode.TreeDataProvider<vscode.TreeItem> {
    private _selectedNode!: DependencyTreeNode;
    ...
    public get selectedNode(): DependencyTreeNode {
        return this._selectedNode;
    }

    public set selectedNode(value: DependencyTreeNode) {
     ...
     */
    private getTitleNodes(selectedNode: DependencyTreeNode): vscode.TreeItem[] {
     ...
     */
    private getVulnerabilityNodes(selectedNode: DependencyTreeNode): VulnerabilityNode[] {
