...
export class DescriptorUtils {
     ...
     */
    public static getChildrenImpact(root: DependencyTreeNode, componentWithIssue: IComponent): IImpactGraph[] {
     ...
     */
    public static getDependencyGraph(workspaceDependenciesTree: DependencyTreeNode, descriptorPath: string): RootNode | undefined {
