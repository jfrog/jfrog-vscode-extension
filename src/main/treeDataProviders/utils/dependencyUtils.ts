...
export class DependencyUtils {
    ...
    private static async scanProjectDependencyGraph(
        ...
        // Populate response
        let uniqueIssueCount: number = (dependencyIssues.dependenciesGraphScan.vulnerabilities || dependencyIssues.dependenciesGraphScan.violations)
            .length;
        ...
        let impactedComponentsCount: number = DependencyUtils.populateDependencyScanResults(projectNode, dependencyIssues);
        scanManager.logManager.logMessage(
            'Found ' +
                +uniqueIssueCount +
                ' unique CVE/License issues that impact ' +
                impactedComponentsCount +
                ' components for descriptor ' +
        ...
        return impactedComponentsCount;
    }
