...
import { MavenTreeNode } from '../../dependencyTree/dependenciesRoot/mavenTree';
...
export class MavenUtils {
     ...
     */
    public static async updateContextValue(node: DependencyTreeNode, dependenciesMatch?: RegExpMatchArray | null, parentCanReachPom?: boolean) {
     ...
     */
    private static isPomReachable(node: DependencyTreeNode, pomDependencies?: RegExpMatchArray | null, parentCanReachPom?: boolean): boolean {
    ...
    private static isNodeDirectDependency(node: DependencyTreeNode) {
        return node.parent instanceof MavenTreeNode;
    }

    private static isNodeInPom(node: DependencyTreeNode, pomDependencies?: RegExpMatchArray | null) {
     ...
     */
    public static async openPomXml(dependenciesTreeNode: DependencyTreeNode): Promise<vscode.TextDocument | undefined> {
