...
export class DependencyTreeNode extends vscode.TreeItem {
    private _children: DependencyTreeNode[] = [];
    ...
    constructor(
        ...
        private _parent?: DependencyTreeNode,
        contextValue?: string
    ) {
    ...
    public get parent(): DependencyTreeNode | undefined {
        return this._parent;
    }

    public set parent(parent: DependencyTreeNode | undefined) {
        this._parent = parent;
    }
    ...
    public get children(): DependencyTreeNode[] {
        return this._children;
    }

    public set children(value: DependencyTreeNode[]) {
    ...
    public addChild(child: DependencyTreeNode) {
        this.children.push(child);
        child.parent = this;
    }

    public shallowClone(): DependencyTreeNode {
        let clone: DependencyTreeNode = new DependencyTreeNode(this.generalInfo, this.collapsibleState);
    ...
    protected fillShallowClone(clone: DependencyTreeNode) {
    ...
    private setTopSeverity(child: DependencyTreeNode) {
