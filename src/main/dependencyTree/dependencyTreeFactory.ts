...
import { NugetUtils } from '../utils/dependency/nugetUtils';

export class DependencyTreesFactory {
    public static async createDependenciesTrees(
        ...
        checkCanceled: () => void,
        parent: DependencyTreeNode = new DependencyTreeNode(new GeneralInfo('', '', [], '', PackageType.Unknown))
