...
export class RootNode extends DependencyTreeNode {
    private _projectDetails: ProjectDetails;
    private _fullPath: string;

    constructor(private _workspaceFolder: string, packageType: PackageType, parent?: DependencyTreeNode, contextValue?: string) {
    ...
    protected upgradableDependencies(scanCacheManager: ScanCacheManager, node: DependencyTreeNode) {
