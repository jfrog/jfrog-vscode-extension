...
import { NpmUtils, ScopedNpmProject } from '../../utils/dependency/npmUtils';
...
export class YarnTreeNode extends RootNode {
    ...
    private populateDependencyTree(dependencyTreeNode: DependencyTreeNode, nodes: any[]) {
        if (!nodes) {
            return;
        }
        for (let node of nodes) {
            ...
            let child: DependencyTreeNode = new DependencyTreeNode(generalInfo, treeCollapsibleState, dependencyTreeNode);
