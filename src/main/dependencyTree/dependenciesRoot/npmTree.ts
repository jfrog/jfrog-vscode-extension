...
import { NpmGlobalScopes, NpmUtils, ScopedNpmProject } from '../../utils/dependency/npmUtils';
...
export class NpmTreeNode extends RootNode {
    ...
    private populateDependenciesTree(dependenciesTreeNode: DependencyTreeNode, dependencies: any, globalScope: string) {
        if (!dependencies) {
            return;
        }
